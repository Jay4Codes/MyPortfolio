...
export const works = {
  work: [
    [
      ...
      "Implemented Machine Learning pipelines that extract tabular data from geochemical and material reports, tuning auto-encoder-based bore-hole compression and predictive models for rig-well data for clients at Saudi Aramco.Developed SaaS for project portals, automated workflows, material test approvals, wireline calculations and NLP-based Incident classifying app using Power Apps, Power Automate, and SharePoint that automates manual work. Designed SharePoint sites as data repositories for various internal teams including data migration, UI developments and BI dashboards using Microsoft Teams, Outlook, SharePoint, and Power BI saving revenue from external vendors.",
      "Feb 2023 - Oct 2023",
      "Pune, India",
    ],
    // [
    ...
    [
      ...
      "NeyX",
      "https://neyx.in",
      "Developed Django REST framework-based APIs for an NLP-based e-commerce bargaining chatbot's dashboard. Worked within an Agile Scrum framework utilizing tools like Digital Ocean, GitHub, Docker, Jira, and PostgreSQL.",
      "Dec 2022 - Feb 2023",
      "Remote",
    ],
    [

...
export const works = {
  work: [
    [
      ...
      "Enhanced 27% increase in predicted index price correlation & developed analysis pipelines for statistical and ML models (like XGBoost) using optimized data structures in C++, MLflow, Python & PostgreSQL. Optimized infrastructural improvements reducing latency for math operations in execution strategies and financial risk management using state-of-the-art software design patterns for medium-frequency trade modelling and data generation pipelines with reduced and hashed storage consumption.",
      "June 2024 - Present",
      "Mumbai, India",
    ],
    [
      ...
      "Engineered orchestration of ensemble approach to benchmarked LLMs and foundation open-source NER models-based pipelines that automate the complete process of extracting and ingesting data from Claim document files to databases resulting in 39% automated data processing and resource savings. Leveraged Neo4j graph database to identify fraudulent and outlier entities in payment gateway pipelines using clustering algorithms namely DBSCAN (density-based), Hierarchial and K-Means clustering.",
      "Feb 2024 - May 2024",
      "Pune, India",
    ],
    [
      ...
      "Fine-tuned auto-encoder-based bore-hole compression by 50% less inference time, predictive modelling on rig-well data for clients at Saudi Aramco, and extracted tabular data from geochemical reports by OCR. Developed such SaaS use cases for stakeholders namely an NLP and OCR based Incident classifier, automated wireline workflows and calculations, reducing manual SME efforts, and saving vendors costs.",
      "Feb 2023 - Oct 2023",
      "Pune, India",
    ],
    [
      ...
      "Developed Django REST APIs for an NLP-based e-commerce bargaining chatbot's dashboard. Worked within a Scrum framework with Jira, Git, Docker, Postman, Digital Ocean, & PostgreSQL",
      "Dec 2022 - Jan 2023",
      "Remote, India",
    ],
    [
      ...
      "CitJo",
      "https://www.citjo.in",
      "Engineered a sustainable serverless cloud architecture using AWS Amplify, S3, Cognito, DynamoDB, AppSync, and GraphQL and deployed a CI/CD pipeline for the app's backend",
      "Jul 2022 - Oct 2022",
      "Mumbai, India",
    ],
    [
      ...
      "https://djss4ds.in/",
      "Led a team of over 80 students to organise numerous community events that comprised pan-India hackathons, seminars and workshops to promote Data Science and AI. Co-hosted the 6th International Conference on Data Management, Analytics and Innovation.",
      "Oct 2021 - Jun 2023",
      "Mumbai, India",
    ],
  ],
...
export const projects = {
  project: [
    [
      "Ernst & Young (EY) Techathon - OTT Product-AD Matching Engine",
      "HuggingFace | OpenCV | Tensorflow | Google Cloud",
      "An AI pipeline that processes OTT content frame by frame, segments products using Meta's Segment Anything Model & matches them to e-commerce listings or ADs using Google Vision Transformer",
      "./images/projects/ey-techathon.png",
      "",
      "https://github.com/Jay4Codes/EY-Techathon",
    ],
    [
      "Baker Hughes - Big Data Pipeline Challenge",
      "PySpark | GCP | Streamlit | Pandas | NumPy | Matplotlib",
      "ETL Pipeline and real-time visualisation dashboard on gas turbine data using Google Cloud's DataProc (Hadoop-based clusters and jobs) with PySpark, awarded 3rd place at Texas A&M University's Datathon",
      "./images/projects/bakerhughes.png",
      "https://jay4codes-tamu-datathon-main-orrlds.streamlit.app/",
      "https://github.com/Jay4Codes/BigDataPipeline",
    ],
    [
      "Time Series Correlation Analysis",
      "Tensorflow | Scipy | Sci-kit learn | Pandas | NumPy",
      "Comprehensive research analysis on the efficacy of time series models and recurrent neural networks for JP Morgan stock price and its correlation to indexes using ARIMA, GARCH, LSTM, and CNN models",
      "./images/projects/tsa.png",
      "",
      "https://github.com/Jay4Codes/TimeSeriesAnalysis",
    ],
    [
...
export const skills = {
  languages: [
    ...
    ["C++", "./icons/cpp.svg"],
    ["SQL", "./icons/sql.png"],
    ["Unix Bash Shell Scripting", "./icons/bash.svg"],
    // ["JavaScript", "./icons/js.svg"],
    // ["Prolog", "./icons/prolog.svg"],
  ],
  cloud: [
    ["AWS", "./icons/aws.svg"],
    ["Google Cloud (GCP)", "./icons/gcp.svg"],
  ...
  data_science: [
    ...
    ["Sci-kit learn", "./icons/scikit.png"],
  ...
  machine_learning: [
    ...
    ["Large Language Models (LLMs)", "./icons/llm.svg"],
    ["Deep Learning", "./icons/dl.png"],
    ["Computer Vision (OpenCV)", "./icons/opencv.svg"],
    ["Time Series Analysis", "./icons/tsa.png"],
    ["Natural Language Processing (NLP)", "./icons/nlp.svg"],
    ["CUDA", "./icons/cuda.svg"],

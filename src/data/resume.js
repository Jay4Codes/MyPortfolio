...
export const works = {
  work: [
    [
      ...
      "Optimized execution strategies for order placing and statistical models based on bid-ask spread of the order book reducing latency profiling by 80 nanoseconds and quantitative infrastructural improvements",
      "June 2024 - Present",
      "Mumbai, India",
    ],
    [
      ...
      "Engineered orchestration of ensemble approach to benchmarked LLMs and foundation NER models-based pipelines that automate the complete process of extracting and ingesting data from Claim document files to databases resulting in 39% automated data processing and resource savings",
      "Feb 2024 - May 2024",
      "Pune, India",
    ],
    [
      ...
      "Fine-tuned auto-encoder-based bore-hole compression by 50% less inference time, predictive modelling on rig-well data for clients at Saudi Aramco, and extracted tabular data from geochemical reports by OCR ◦ Developed SaaS use cases for stakeholders namely an NLP-based Incident classifier, automated workflows and wireline calculations, reducing manual SME effort, saving vendors costs",
      "Feb 2023 - Oct 2023",
      "Pune, India",
    ],
    [
